...
export default function Login() {
  const { register, handleSubmit, errors, handleOAuth, control } = useLogin();
      ...
      <div className="flex w-full flex-col items-center justify-center p-6 sm:p-12 lg:w-[40%]">
        <div className="w-full max-w-100">
          ...
          <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              className="mt-2 w-full rounded-lg bg-[#e02b2b] p-3 text-base font-bold text-white transition-colors hover:bg-[#c92525]"
            >
              Entrar
            </button>
